  ...
  return (
    <PageShell>
      <PageHeader
        ...
        description="We'd love to hear from students, alumni, and the community."
      />
            ...
            <ClayCard tilt={false} className="h-full">
              ...
              <ul className="mt-5 space-y-4 text-sm">
                <li className="flex items-center gap-3">
                  <MapPin className="h-5 w-5 text-primary" /> {s.location}
                </li>
                <li className="flex items-center gap-3">
                  <User className="h-5 w-5 text-primary" /> {s.programmeOfficer} (Programme Officer)
                </li>
                <li className="flex items-center gap-3">
          ...
          <Reveal delay={0.1}>
            <ClayCard tilt={false} className="h-full">
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                Visit the NSS room during school hours, or email us with your name, batch (if any),
                and message. For collaboration or media requests, please mention your organization.
              </p>
