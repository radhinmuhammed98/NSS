...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'showOnHome',
      title: 'Show on Homepage? / ഹോംപേജിൽ കാണിക്കണോ?',
      type: 'boolean',
      description: 'Turn this on to show this project on the homepage. / വെബ്സൈറ്റിന്റെ പ്രധാന പേജിൽ കാണിക്കാൻ ഇത് ഓൺ ചെയ്യുക.',
      group: 'advanced',
      initialValue: true,
    }),
  ],
