...
- **Day-Wise Activities**: 7 entries containing:
  - _Day Number_: 1 to 7.
  - _Date_: YYYY-MM-DD.
  - _Title_: E.g., `Day 1: Inaugural Session & Survey`.
  - _Description_: Summary of that day's events.
  - _Activities_: List of tasks completed.
  - _Guests_: Visiting dignitaries/speakers.
  - _Images_: Photos from that specific day.
